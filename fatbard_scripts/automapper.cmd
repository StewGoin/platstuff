...
# automapper.cmd version 6.4
# last changed: Jan 8, 2019
...
ABSOLUTE_TOP:
     ...
     var swim_FAIL var swim_FAIL ^You struggle (?!to maintain)|^You work(?! your way (?:up|down) the cliff)|^You slap|^You flounder
     ...
     var move_STOW ^You need to empty your hands|^You should empty your hands first\!|^You can't possibly manage to cross the rope bridge while holding|^You'll need to free up your hands|^Not while carrying something in your hands
...
move.stow:
     ...
     pause 0.3
     if ("$righthand" != "Empty") then send unload $righthandnoun
     pause 0.4
     if matchre("$righthand", "khuj|staff|atapwi") then send wear $righthandnoun
     put %movement
     pause 0.1
     goto move.done
move.boat:
