# Work to integrate this with includes.cmd to make a master include. Nested includes may be simplest for script compatibility.
...
var pelts.empty (rat pelt|goblin skin|goblin hide|hog hoof|razorsharp claw|leucro pelt|white pelt|curved tusk|caracal pelt|plated claw|eel skin)
#######################################################################################################################################
...
var todo $0
sell1:
matchre return ^The tanner Falken ponders over the bundle
matchre return ^You ask the tanner Falken to buy a lumpy bundle\.
matchre return ^The tanner Falken frowns
