...
###########################################
# CHANGELOG - Latest Update: 1/27/2021
#
...
if (("$zoneid" = "66") && ($Athletics.Ranks >= %undergondola)) then gosub AUTOMOVE 315
...
RANDOMWEIGHT:
     var weight $1
     var randomweight
     if $UC_%weight then var randomweight %randomweight|%weight
