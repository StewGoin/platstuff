...
setvariable route1 1j->Map1j_|2->WestGate|2a->Map2a_|4->WestGate|4a->WestGate|6->Map6_|7->NTR|8->EASTGATE|8a->EASTGATE|9a->NTR|9b->NTR|10->NTR|11->NTR|12->NTR|12a->NTR|13->NTR|14b->NTR|14c->NTR|14d->NTR
...
setvariable route7 1->crossing|1j->crossing|2->crossing|2a->crossing|4->crossing|4a->crossing|6->crossing|7a->Map7a_|7b->Map7b_|7c->NTR|8->Map8_|8a->Map8_|9a->Map9a_|9b->Map9b_|10->Map10_|11->Map11_|12->Map12_|12a->Map12a_|13->NTR|14b->NTR|14c->Map14c_|14d->NTR
setvariable route7a 1->Map7_|1j->Map7_|2->Map7_|2a->Map7_|4->Map7_|4a->Map7_|6->Map7_|7->Map7_|7b->Map7_|7c->Map7_|8->Map7_|8a->Map7_|9a->Map7_|9b->Map7_|10->Map7_|11->Map7_|12->Map7_|12a->Map7_|13->Map7_|14b->Map7_|14c->Map14c_|14d->Map7_
...
setvariable route12a 1->Map7_|1j->NTR|2->Map7_|2a->Map7_|4->Map7_|4a->Map7_|6->Map7_|7->Map7_|7a->Map7_|7b->Map7_|7c->Map7_|8->Map7_|8a->Map7_|9a->Map7_|9b->Map7_|10->Map7_|11->Map7_|12->Map7_|13->Map7_|14b->Map7_|14c->Map7_|14d->Map7_
setvariable route13 1->NTR|1j->NTR|2->NTR|2a->NTR|4->NTR|4a->NTR|6->NTR|7->NTR|7a->NTR|7b->NTR|7c->NTR|8->NTR|8a->NTR|9a->NTR|9b->NTR|10->NTR|11->NTR|12->NTR|12a->NTR|14b->NTR|14c->NTR|14d->NTR
setvariable route14b 1->NTR|1j->NTR|2->NTR|2a->NTR|4->NTR|4a->NTR|6->NTR|7->NTR|7a->NTR|7b->NTR|7c->NTR|8->NTR|8a->NTR|9a->NTR|9b->NTR|10->NTR|11->NTR|12->NTR|12a->NTR|13->NTR|14c->NTR|14d->NTR
setvariable route14c 1->NTR|1j->NTR|2->NTR|2a->NTR|4->NTR|4a->NTR|6->NTR|7->NTR|7a->NTR|7b->NTR|7c->NTR|8->NTR|8a->NTR|9a->NTR|9b->NTR|10->NTR|11->NTR|12->NTR|12a->NTR|13->NTR|14b->NTR|14d->NTR
setvariable route14d 1->NTR|1j->NTR|2->NTR|2a->NTR|4->NTR|4a->NTR|6->NTR|7->NTR|7a->NTR|7b->NTR|7c->NTR|8->NTR|8a->NTR|9a->NTR|9b->NTR|10->NTR|11->NTR|12->NTR|12a->NTR|13->NTR|14b->NTR|14c->NTR
...
SHARD_ROUTES_LABEL:
setvariable route65 66->portal|67->portal|68->portal|68a->portal|68b->portal|69->portal
setvariable route66 65->Map65_|67->Map67_|68->Map68_|68a->Map68_|68b->Map68_|69->Map69_
setvariable route67 66->portal|68->Map68_|68a->Map68_|68b->Map68_|69->Map69_
setvariable route68 66->portal|67->Map67_|68a->Map68a_|68b->Map68b_|69->Map67_
...
setvariable route69 66->portal|67->portal|68->Map66|68a->portal|68b->portal
...
if "%gateway.room" = "WestGate" then goto WESTGATEXING
if "%gateway.room" = "EASTGATE" then goto EASTGATEXING
