...
var LumberStorage bright.pouch
...
var MaterialKeepList (azurelle|copperwood|silverwood|avodire|hickory|lelori|sandalwood|dragonwood|yew|cherry|crabwood|ebony|albarco|ilomba|osage|rosewood|ironwood|macawood|smokewood|bocote|tamarak|adder|darkspine|goldwood|aformosia|bloodwood|ramin|redwood|kapok|mistwood|diamondwood|greenheart|rockwood|alerce|e'erdream|glitvire|gloomwood|iroko|tamboti|zingana) (\w*)
...
DangerFailure:
	...
	match DangerClear You scan the area for danger and find nothing of concern lurking within the nearby forest.
